                ...
                <div class="offcanvas__content">
                    ...
                    <div class="offcanvas__contact text-center">
                        ...
                        <div class="offcanvas__contact-text mb-2">
                            <p><a href="https://html.bdevs.net/cdn-cgi/l/email-protection#2c5c4d5e4d4843546c49544d415c4049" target="_blank"><span class="__cf_email__" data-cfemail="5424352635303b2c14312c35392438317a373b39">[email&#160;protected]</span></a></p>
        ...
        <section class="error_section text-center mouse_move">
            <div class="container">
                <div class="error_image decoration_wrap text-center">
                    <img src="{{ url('/') }}/assets/images/bg/error.png" alt="">
                </div>
                <div class="error_content">
                    <h1>Page not found</h1>
                    <p>
                        The requested URL you are looking for doesn’t <span class="d-md-block">exist on this server.</span>
                    </p>
                    <a href="{{ url('/')}}" class="bd-btn-link btn_primary">
...
<script data-cfasync="false" src="https://html.bdevs.net/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
